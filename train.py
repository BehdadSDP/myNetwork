...
from utils.dehazeloss import dehazeloss
...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/fogging1.yaml', help='dataset.yaml path')
    parser.add_argument('--hyp', type=str, default=ROOT / 'data/hyps/myhyp.yaml', help='hyperparameters path')
